...
export class FetchApiDataService {
  ...
  */
  ...
  /**
   * calls API endpoint to add a user
   * @returns data of user in JSON format
   */
  ...
  /**
   * calls API endpoint to update user
   * @returns JSON object holding data about updated user
   */
